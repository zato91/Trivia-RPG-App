...
Character.create(name:"Axel",bio:"Fighting Style: Balanced",tagline:"Come back when you've learned how to fight!",max_hp:15,armor:10,energy:2)
Character.create(name:"Blaze",bio:"Fighting Style: Finesse",tagline:"I hope I didn't hurt your ego too badly... Oops!",max_hp:10,armor:10,energy:3)
Character.create(name:"Diva",bio:"Fighting Style: Ability Based",tagline:"You haven't felt my full power.",max_hp:10,armor:5,energy:4)
Character.create(name:"Floyd",bio:"Fighting Style: Brute Force",tagline:"Can't you see how pathetic your attacks are!",max_hp:20,armor:15,energy:1)
